...
public class Mv extends Command {
    ...
    private boolean operateSystem() {
      ...
      if(copy.isFile) {
        copy.getParent().removeFileByName(copy.getName());
      }else {
        copy.getParent().removeDirectoryByName(copy.getName());
      }
